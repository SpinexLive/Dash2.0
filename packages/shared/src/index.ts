...
export type RealtimeEvent =
  | { type: 'member.created'; userId: string }
  | { type: 'recruit.updated'; recruitId: string; status: RecruitStatus }
  | { type: 'roster.updated'; rosterId: string; slotId: string; response: SlotResponse }
  | { type: 'briefing.tick'; at: string };

export const REALTIME_CHANNEL = 'events';
